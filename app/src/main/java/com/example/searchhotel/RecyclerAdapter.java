       ...
       /* holder.nametext.setText(model.getName());
        ...
        holder.hotelImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.wrap,new DescriptionFragment(model.getHotelListTag(),model.getHotelLocation(),model.getHotelName(),model.getHotelRating(), model.getImageUri())).addToBackStack(null).commit();
            }
        });
    }
